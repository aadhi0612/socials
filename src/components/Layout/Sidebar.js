...
const Sidebar = () => {
    ...
    return (_jsxs("div", { className: "w-64 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 flex flex-col h-full", children: [_jsx("div", { className: "p-6 border-b border-gray-200 dark:border-gray-700", children: _jsxs("div", { className: "flex items-center space-x-3", children: [_jsx("div", { className: "w-10 h-10 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-lg flex items-center justify-center", children: _jsx("span", { className: "text-lg font-bold text-black", children: "EY" }) }), _jsxs("div", { children: [_jsx("h1", { className: "text-lg font-bold text-gray-900 dark:text-white", children: "EY Social Posts" }), _jsx("p", { className: "text-xs text-gray-500 dark:text-gray-400", children: "Building a better working world" })] })] }) }), _jsx("nav", { className: "flex-1 p-4 space-y-2", children: navItems.map((item) => (_jsxs(NavLink, { to: item.path, className: ({ isActive }) => `
            ...
            `, children: [_jsx(item.icon, { className: "w-5 h-5" }), _jsx("span", { children: item.label })] }, item.path))) }), _jsxs("div", { className: "p-4 border-t border-gray-200 dark:border-gray-700", children: [_jsxs("div", { className: "flex items-center space-x-3 mb-4", children: [_jsx("img", { src: user?.avatar || 'https://images.pexels.com/photos/3783725/pexels-photo-3783725.jpeg?auto=compress&cs=tinysrgb&w=150&h=150&dpr=2', alt: user?.name, className: "w-10 h-10 rounded-full" }), _jsxs("div", { className: "flex-1 min-w-0", children: [_jsx("p", { className: "text-sm font-medium text-gray-900 dark:text-white truncate", children: user?.name }), _jsxs("p", { className: "text-xs text-gray-500 dark:text-gray-400 truncate", children: [user?.role, " \u2022 EY Global"] })] })] }), _jsxs("button", { onClick: logout, className: "flex items-center space-x-2 w-full px-3 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors", children: [_jsx(LogOut, { className: "w-4 h-4" }), _jsx("span", { children: "Sign Out" })] })] })] }));
};
